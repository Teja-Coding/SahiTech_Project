...
public class PkdAuthorizationServiceImpl implements PkdAuthorizationService {
	...
	public void printReport(PoHdr poHdrHq){
        ...
        if (null != poHdrHq && poHdrHq.getPoHdrSeqno() > 0)
        {
            ...
            Component comp = (Component) Executions.createComponents("/WEB-INF/reports/reportZul.zul", null, params);
            ((org.zkoss.zk.ui.Component) comp).setAttribute("REPORT_PATH", reportPath);
            ((org.zkoss.zk.ui.Component) comp).setAttribute("PARAMETERS_MAP", params);
